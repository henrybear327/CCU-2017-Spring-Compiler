...
public interface CactusListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CactusParser#dot}.
	 * @param ctx the parse tree
	 */
	void enterDot(CactusParser.DotContext ctx);
	/**
	 * Exit a parse tree produced by {@link CactusParser#dot}.
	 * @param ctx the parse tree
	 */
	void exitDot(CactusParser.DotContext ctx);
}