// Generated from S_attributed.g4 by ANTLR 4.7
...
public class S_attributedParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "S_attributed.g4"; }
	...
	public S_attributedParser(TokenStream input) {
		super(input);
	...
	public static class SContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitS(this);
		}
	}
	...
	public final SContext s() throws RecognitionException {
		...
		try {
			...
			{
			setState(12);
			((SContext)_localctx).ret_l = l();
			setState(13);
			((SContext)_localctx).ret_r = r();
			System.out.println(((SContext)_localctx).ret_l.val + ((SContext)_localctx).ret_r.val / ((SContext)_localctx).ret_r.base);
			}
		}
	...
	public static class RContext extends ParserRuleContext {
		...
		public double val;
		public LContext ret_l;
		public TerminalNode DOT() { return getToken(S_attributedParser.DOT, 0); }
		public LContext l() {
			return getRuleContext(LContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitR(this);
		}
	}
	...
	public final RContext r() throws RecognitionException {
		...
		try {
			...
			case DOT:
				...
				match(DOT);
				setState(17);
				((RContext)_localctx).ret_l = l();
				((RContext)_localctx).base =  ((RContext)_localctx).ret_l.base; ((RContext)_localctx).val =  ((RContext)_localctx).ret_l.val;
				}
				break;
			case EOF:
				enterOuterAlt(_localctx, 2);
				{
				((RContext)_localctx).base =  1; ((RContext)_localctx).val =  0;
				}
				break;
			default:
	...
	public static class LContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterL(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitL(this);
		}
	}
	...
	public static class LsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterLs(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitLs(this);
		}
	}
	...
	public static class BContext extends ParserRuleContext {
		public double val;
		public TerminalNode ZERO() { return getToken(S_attributedParser.ZERO, 0); }
		public TerminalNode ONE() { return getToken(S_attributedParser.ONE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterB(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitB(this);
		}
	}
	...
	public static class TokenContext extends ParserRuleContext {
		public List<TerminalNode> ZERO() { return getTokens(S_attributedParser.ZERO); }
		public TerminalNode ZERO(int i) {
			return getToken(S_attributedParser.ZERO, i);
		}
		public List<TerminalNode> ONE() { return getTokens(S_attributedParser.ONE); }
		public TerminalNode ONE(int i) {
			return getToken(S_attributedParser.ONE, i);
		}
		public List<TerminalNode> DOT() { return getTokens(S_attributedParser.DOT); }
		public TerminalNode DOT(int i) {
			return getToken(S_attributedParser.DOT, i);
		}
		public List<TerminalNode> WHITESPACE() { return getTokens(S_attributedParser.WHITESPACE); }
		public TerminalNode WHITESPACE(int i) {
			return getToken(S_attributedParser.WHITESPACE, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).enterToken(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof S_attributedListener ) ((S_attributedListener)listener).exitToken(this);
		}
	}
